...
function M.run(opts)
    ...
    for _, spec in ipairs(file_sizes) do
        ...
        ctx:log(
            string.format(
                "  insert: avg=%.3fms median=%.3fms p95=%.3fms",
                insert_stats.avg,
                insert_stats.median,
                insert_stats.p95
            )
        ...
        ctx:log(
            string.format(
                "  delete: avg=%.3fms median=%.3fms p95=%.3fms",
                delete_stats.avg,
                delete_stats.median,
                delete_stats.p95
            )
        ...
        ctx:log(
            string.format(
                "  cursor move: avg=%.3fms median=%.3fms p95=%.3fms",
                move_stats.avg,
                move_stats.median,
                move_stats.p95
            )
        ...
        ctx:log(
            string.format("  visual select/delete: avg=%.3fms median=%.3fms", visual_stats.avg, visual_stats.median)
        )
